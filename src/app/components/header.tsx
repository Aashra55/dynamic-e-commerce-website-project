...
export default function Header() {
  useEffect(() => {
    ...
    const handleClick = () => {
      if (collapseMenu) {
        // Check if collapseMenu is not null
        ...
        <div className="flex flex-wrap items-center lg:gap-y-2 gap-4 w-full">
            ...
            <ul className="lg:flex lg:gap-x-3 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
              <li className="mb-6 hidden max-lg:block">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <button className="px-4 py-2 text-sm rounded-full text-white border-2 border-red-600 bg-red-600 hover:bg-red-700">
              ...
              <li className="max-lg:border-b max-lg:py-3 px-3">
                <Link
                  href="/"
                  className="text-[#333] hover:text-red-600 text-[15px] block font-semibold"
                >
                  Home
                </Link>
              </li>
              <li className="max-lg:border-b max-lg:py-3 px-3 outline-none">
                <Link
                  href="javascript:void(0)"
                  className="text-[#333] hover:text-red-600 text-[15px] block font-semibold outline-none"
                >
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                      <DropdownMenuItem>
                        <Link href={"../components/fruits"}>Fruits</Link>
                      </DropdownMenuItem>
                      <DropdownMenuItem id="vegetables">
                        <Link href={"../components/vegetables"}>
                          Vegetables
                        </Link>
                      </DropdownMenuItem>
                      <DropdownMenuItem id="dairyAndEggProducts">
                        <Link href={"../components/dairy"}>
                          Dairy & Egg Products
                        </Link>
                      </DropdownMenuItem>
                      <DropdownMenuItem id="snacks&Beverages">
                        <Link href={"../components/snacks"}>
                          Snacks & Beverages
                        </Link>
                      </DropdownMenuItem>
                    </DropdownMenuContent>
          ...
          <div className="flex items-center gap-x-6 gap-y-4 ml-auto">
            ...
            <div className="flex items-center sm:space-x-8 space-x-6">
              ...
              <button className="max-lg:hidden px-4 py-2 text-sm rounded-full text-white border-2 border-red-600 bg-red-600 hover:bg-red-700">
                <Link href={"/sign-in"}>Sign In</Link>
              </button>

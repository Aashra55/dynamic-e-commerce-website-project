      ...
      {data.map((items, index: number) => (
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            {items.fruitItems?.map((e: ProductItem, index: number) => (
              <div
                key={index}
              ...
              >
                <div className="p-4 sm:p-6">
                  <div className="bg-pink-100 absolute z-[2] w-7 h-7 sm:w-9 sm:h-9 flex items-center justify-center rounded-full cursor-pointer absolute top-2 right-2 sm:top-4 sm:right-4">
                    {WishList[e.id] ? (
                      <GoHeartFill

...
export default function ProductDetails(
  ...
  if (!details) {
    return (
      <div className="w-[100%] text-center p-[15px]">Product Not Found</div>
    );
  }
  ...
  return (
    <div className="max-w-4xl m-[15px] mx-auto p-6 bg-white border border-gray-200 rounded-lg shadow-md ">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 md:pl-6 flex flex-col justify-center">
          ...
          <button
            ...
            type="button"
            className="focus:outline-none w-full flex items-center justify-center gap-2 mt-6 px-2 py-2.5 sm:px-4 bg-yellow-400 hover:bg-red-600 hover:text-black text-sm text-gray-800 font-semibold rounded-md transition-transform transform hover:scale-105 active:scale-90 shadow-lg active:shadow-none"
          >
            <svg

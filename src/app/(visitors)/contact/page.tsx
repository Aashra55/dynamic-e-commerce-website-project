...
export default function Contact(){
    return(
      ...
      <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
        ...
        <div className="bg-red-800 rounded-lg p-6 h-full max-lg:order-1">
          ...
          <ul className="flex flex-wrap gap-4 mt-16">
            <li className="bg-yellow-600 hover:bg-yellow-700 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
        ...
        <div className="p-4 lg:col-span-2">
          <form>
              ...
              <div className="col-span-full">
                ...
                <div className="flex max-lg:flex-col gap-6 mt-4">
                  <div className="flex items-center">
                    <input id="radio1" type="radio" name="option" className="hidden peer" />
                  ...
                  <div className="flex items-center">
                    <input id="radio2" type="radio" name="option" className="hidden peer" />
                  ...
                  <div className="flex items-center">
                    <input id="radio3" type="radio" name="option" className="hidden peer" />
            ...
            <button type="submit"
              className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide text-white bg-red-600 hover:bg-red-700">
